...
Every control under **Theme settings**, grouped as the editor shows them.
Ranges show the default value.
...
Ten roles per mode: Page background, Surface, Alternative surface, Text, Muted
text, Borders, Primary action, Text on primary, Secondary action, Text on
...
## Basket and checkout
- **Show accelerated checkout on basket page**
- **Show accelerated checkout in drawer and minicart**
...
- **Rhythm:** Paragraph letter spacing (0), Space after paragraphs (20), Body
  line height (160)
- **Headings:** Max H1 (72), Max H2 (52), Max H3 (32), Heading line height
...
- **Maximum content width** (1200), **Maximum section spacing** (80),
  **Maximum page gutter** (40), **Maximum grid gap** (24)
- **Adaptive card grids:** Product card min / max width (220 / 360),
  Collection card min / max width (300 / 460). Card grids add and remove
  columns based on the width of their section, not fixed breakpoints.

## Buttons and forms
- **Button corner radius** (8), **Input corner radius** (8), **Control height**
  (48), **Use uppercase button labels** (off)
